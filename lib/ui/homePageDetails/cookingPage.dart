    ...
    return SingleChildScrollView(
      ...
      child:  Container(
            ...
            child:Column(
              ...
              children: <Widget>[
                SizedBox(height: 30,),
                _createItem('الأكل الشرقي','images/easternEating.jpg'),
                SizedBox(height: 20,),
                _createItem("الأكل المغربي", 'images/westernEting.jpg'),
                SizedBox(height: 20,),
                _createItem("الحلويات", 'images/candy.jpg'),
                SizedBox(height: 20,),
                _createItem('تجهيز مناسبات', 'images/occasions.jpg'),
