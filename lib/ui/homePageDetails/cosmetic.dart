...
class CosmeticPage extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return _CosmeticState();
  }
}

class _CosmeticState extends State<CosmeticPage>{
  @override
      ...
      children: <Widget>[
        Container(
            ...
            child:Column(
              ...
              children: <Widget>[
                SizedBox(height: 30,),
                _createItem('مواد تجميل','images/cosmeticMateral.jpg'),
                SizedBox(height: 20,),
                _createItem('العناية بالبشرة', 'images/skinCare.jpg'),
                SizedBox(height: 80,),
                SizedBox(height: 80,),
                SizedBox(height: 80,),
              ],
