...
class CraftworksPage extends StatefulWidget{



  @override
  State<StatefulWidget> createState() {
    return _CraftworksPageState();
  }
}

class _CraftworksPageState extends State<CraftworksPage>{
  @override
      ...
      children: <Widget>[
        Container(
            ...
            child:Column(
              ...
              children: <Widget>[
                SizedBox(height: 30,),
                _createItem('الأكسسوارات','images/accessories.jpg'),
                SizedBox(height: 20,),
                _createItem('الكوشات', 'images/handWork.jpg'),
                SizedBox(height: 80,),
                SizedBox(height: 80,),
                SizedBox(height: 80,),
              ],
